...
# Game-related
flags.DEFINE_string("game_name", "risk", "Game name.")
...
flags.DEFINE_integer("gpsro_iterations", 100000,
...
flags.DEFINE_integer("hidden_layer_size", 174, "Hidden layer size")
...
def main(argv):
  ...
  env = rl_environment.Environment(game,{"players": 2,"map":0,"rng_seed":-1,"max_turns":90,"dep_abs":False,"atk_abs":True,"redist_abs":True,"fort_abs":True,"dep_q":31,"atk_q":2,"redist_q":2,"fort_q":2})
